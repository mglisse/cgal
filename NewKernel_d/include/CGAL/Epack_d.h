...
: CGAL_BASE
{
  constexpr Epack_d_help1(){}
  constexpr Epack_d_help1(int d):CGAL_BASE(d){}
};
#undef CGAL_BASE
#define CGAL_BASE \
...
: CGAL_BASE
{
  constexpr Epack_d_help2(){}
  constexpr Epack_d_help2(int d):CGAL_BASE(d){}
};
#undef CGAL_BASE
#define CGAL_BASE \
  Kernel_d_interface< \
...
{
  constexpr Epack_d(){}
  constexpr Epack_d(int d):CGAL_BASE(d){}
};
#undef CGAL_BASE
}
